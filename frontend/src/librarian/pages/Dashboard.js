  ...
  return (
    <div className="dashboard">
      ...
      <div className="cards">
        <button 
          className="card" 
          onClick={() => window.location.href = "/librarian/students"}
        >
        ...
        <button 
          className="card" 
          onClick={() => window.location.href = "/librarian/teachers"}
        >
        ...
        <button 
          className="card" 
          onClick={() => window.location.href = "/librarian/classes"}
        >
        ...
        <button 
          className="card" 
          onClick={() => window.location.href = "/librarian/reports"}
        >
