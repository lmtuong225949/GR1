...
const Header = ({ username = "librarian", onLogout }) => {
  ...
  return (
    <header className="header">
      ...
      <div className="user-header_actions">
        <Link to="/librarian/notifications" className="user-header_notification">
          <Bell />
          {notificationCount > 0 && (
          ...
          {profileOpen && (
            <div className="user-header_dropdown">
              <div className="user-header_dropdown-item user-info-box">
                ...
                <div className="user-role">BGH</div>
              </div>
              <Link to="/librarian/profile" className="user-header_dropdown-item">
                Hồ sơ
              </Link>
